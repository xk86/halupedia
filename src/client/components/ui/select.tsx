...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        // Rethemed: `dark:` variants stripped (our vars already flip).
...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        // Rethemed: shadcn `accent` item-highlight tokens swapped for our
        // control-surface tokens (our --color-accent is the brand red).
