      ...
      >
        {presets.map((p, i) => {
          ...
          return (
            <button
              ...
              onClick={() => setColor(p)}
              className={cn(
                "relative size-5 cursor-pointer overflow-hidden rounded-sm border border-border transition-transform outline-none",
        ...
        {onAdd && (
          <button
            ...
            className={cn(
              "inline-flex size-5 cursor-pointer items-center justify-center rounded-sm border border-dashed border-border text-muted-foreground transition-colors outline-none",
