...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        // Flat border instead of shadow-xs + ring-1: persistent box-shadows on
        // every card force Firefox's WebRender to rasterize & re-composite them
        // on scroll (GPU thrash). A border composites for free.
