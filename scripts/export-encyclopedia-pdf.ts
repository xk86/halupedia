...
import { writeEncyclopediaPdfDump } from "../src/server/encyclopediaPdfDump";
...
if (process.argv.includes("--help")) {
  console.log("Usage: pnpm encyclopedia:pdf [--output path] [--database path] [--media-database path]");
  process.exit(0);
}
